...
The purpose of this assignment is to look at producing a machine learning model which can resonably predict the manner in which a a set of test subjects peform a suite of exercises.
...
Now I have the required columns I'm going to how much data is available in those columns
```{r ref.label="percentageOfNAsInTraining",echo=FALSE,warning=FALSE,message=FALSE}
```

As you can see var_total_accel_belt, var_accel_arm, var_accel_dumbbell and var_accel_forearm all have 97.9% of missing data (NA). The author has decided to remove these columns (predictos) from the subsequent models
...
Now that I have training data set I will perform some analysis to understand the individual importance of the predictors I have selected:
